...
from arango.exceptions import ArangoServerError, IndexCreateError, IndexDeleteError, IndexListError
        ...
        try:
            ...
            if operation == "list_indexes":
                ...
                if index_type == "persistent":
                    ...
                    return {
                        "error": f"Unsupported index type: {index_type}. Supported types: persistent, geo, ttl, fulltext"
                    }
